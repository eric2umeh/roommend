...
const mockPayroll: PayrollRecord[] = [
  { id: '1', staff_name: 'John Okoro', position: 'Manager', salary: 150000, deductions: 15000, net_pay: 135000, status: 'paid', payment_date: '2024-02-10' },
  { id: '2', staff_name: 'Chioma Eze', position: 'Front Desk', salary: 80000, deductions: 8000, net_pay: 72000, status: 'paid', payment_date: '2024-02-10' },
  { id: '3', staff_name: 'Tunde Adeyemi', position: 'Chef', salary: 120000, deductions: 12000, net_pay: 108000, status: 'pending', payment_date: '2024-02-28' },
  { id: '4', staff_name: 'Grace Obi', position: 'Housekeeper', salary: 60000, deductions: 6000, net_pay: 54000, status: 'pending', payment_date: '2024-02-28' },
]
...
export default function PayrollPage() {
  const columns: Column<PayrollRecord>[] = [
    ...
    { key: 'net_pay', label: 'Net Pay', render: (v) => <span className="font-semibold">₦{v.toLocaleString()}</span> },
