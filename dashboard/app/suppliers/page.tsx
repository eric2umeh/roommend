...
const mockSuppliers: Supplier[] = [
  ...
  },
  {
    ...
    contact: "+234 702 345 6789",
    email: "info@niglinen.com",
  ...
  },
  {
    ...
    email: "sales@premiumclean.ng",
    payment_terms: "COD",
    status: "active",
  },
  {
    id: "4",
    name: "Tech Equipment Distributors",
    category: "Equipment",
    contact: "+234 704 567 8901",
    email: "support@techtrade.ng",
...
export default function SuppliersPage() {
  const columns: Column<Supplier>[] = [
    ...
    { key: "payment_terms", label: "Payment Terms" },
    {
      ...
      render: (v) => (
        <span
          className={`px-2 py-1 rounded text-xs ${v === "active" ? "bg-green-100 text-green-800" : "bg-slate-100 text-slate-800"}`}
        >
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border border-slate-200 p-6">
        <DataTable
          ...
          filters={filters}
          mobileColumns={["name", "category", "status"]}
        />
      </div>
    </div>
  );
